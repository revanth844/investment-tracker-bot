...
Just message your bot directly — no code editing needed ever again:
...
|`/add SYMBOL NAME DATE LOW HIGH TYPE [TARGET]`|Add a new recommendation|
|`/remove SYMBOL`|Stop tracking a stock|
|`/news SYMBOL DATE pos/neu/neg Text`|Add a news event to the chart|
|`/update`|Trigger an immediate refresh|
